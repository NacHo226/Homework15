...
namespace Task1.Tests
{
    ...
    {
        private readonly ILogger<Task2> _logger = new MyLogger<Task2>().Logger;
        ...
        public void SecondTaskTest()
        {
            ...
            var actionAppName =
                WaitServices.GetVisibleElement(By.CssSelector("div.sIskre > c-wiz:nth-child(1) > h1 > span"));
            ...
            _logger.LogInformation(
                $"Number of similar applications in GooglePlay: {WaitServices.GetVisibleElements(By.CssSelector("div.ZmHEEd > div.ImZGtf")).Count}");
